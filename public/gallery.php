...
<body>
    ...
    <div class="container mt-5 pt-5">
        <h1 class="mb-4">Galeri Sekolah</h1>
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="https://via.placeholder.com/400x300" class="card-img-top" alt="Galeri 1">
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="https://via.placeholder.com/400x300" class="card-img-top" alt="Galeri 2">
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="https://via.placeholder.com/400x300" class="card-img-top" alt="Galeri 3">
                    <div class="card-body">
